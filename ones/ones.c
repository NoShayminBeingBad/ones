...
/*
*
* outputes a constant flow of the last_char as an output, default is '1'
*
*/
...
/*
*
* saves the last character of the message that was written to "ones"
*
*/
static ssize_t ones_write(struct file *f, const char *buf, size_t size, loff_t *offset){
	if (size <= 0)
		return 0;
